...
class EstateTestCase(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.properties_tags_0 = cls.env["estate.property.tags"].create(
            [cls.vals_tags_0]
        )

        cls.vals_type_0 = {"name": "villa"}
        cls.properties_type_0 = cls.env["estate.property.type"].create(
            [cls.vals_type_0]
        )
    ...
    def test_add_properties(self):
        ...
        default_values = {
            "bedrooms": 2,
            "date_availability": default_date_availability,
            "active": True,
            "state": "new",
        }
        computed_values = {
            "total_area": self.property_vals_0["living_area"]
            + self.property_vals_0["garden_area"],
